                       ...
                       const std::string &default_model)
{
    ...
    dispatch->addServlet(http::HttpMethod::GET, "/api/v1/healthz", [](http::HttpRequest::ptr request,
                                                                        http::HttpResponse::ptr response,
    ...
    dispatch->addServlet(http::HttpMethod::POST, "/api/v1/chat/completions", [chat_service, chat_settings, default_model](http::HttpRequest::ptr request,
                                                                                                                              http::HttpResponse::ptr response,
                                                                                                                              http::HttpSession::ptr) {
    ...
    dispatch->addServlet(http::HttpMethod::POST, "/api/v1/chat/stream", [chat_service, chat_settings, default_model](http::HttpRequest::ptr request,
                                                                                                                         http::HttpResponse::ptr response,
    ...
    dispatch->addParamServlet(http::HttpMethod::GET,
                              "/api/v1/chat/history/:conversation_id",
                              [chat_service, chat_settings](http::HttpRequest::ptr request,
                                                            http::HttpResponse::ptr response,
                                                            http::HttpSession::ptr) {
        const std::string request_id = GetRequestId(request);
